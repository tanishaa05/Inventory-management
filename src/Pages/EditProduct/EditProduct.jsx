...
export default function EditProduct(){
    ...
    return(
        ...
        <h2 className="editProductsText">Edit Products</h2>
        <span>Update the product information</span>
        <div className="row1">
        ...
        <button className="updateButton" onClick={() => console.log("clicked")}>Update Product</button>
        </div>
        </div>
    )
}